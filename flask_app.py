...
def add_patient():
    if request.method == "POST":
        ...
        db_write(
            "INSERT INTO Patient (patienten_id, Name, Geburtsdatum, Geschlecht, Gewicht, Aktivitaetsstatus, Versicherungsnummer) VALUES (%s, %s, %s, %s, %s, 1, %s)",
            (patienten_id, Name, Geburtsdatum, Geschlecht, Gewicht, Versicherungsnummer,)
        )
